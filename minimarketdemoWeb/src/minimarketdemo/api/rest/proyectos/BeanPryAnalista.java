package minimarketdemo.api.rest.proyectos;
...
public class BeanPryAnalista implements Serializable {
	...
	public void actionListenerActualizarAvance(PryTarea tarea) {
		try {
			...
			PryProyecto proyectoSeleccionado = tarea.getPryProyecto();
			proyectoSeleccionado.setEstado("Desarrollo");
			mProyectos.actualizarEstado(proyectoSeleccionado);
